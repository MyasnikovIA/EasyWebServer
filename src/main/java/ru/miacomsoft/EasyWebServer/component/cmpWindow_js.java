                ...
                function initialize() {
                    ...
                    class DWindow {
                        ...
                        initEventHandlers() {
                            ...
                            // Перемещение окна
                            if (this.titleRow) {
                                this.titleRow.addEventListener('mousedown', (e) => this.startDrag(e));
                            ...
                            resizeHandles.forEach(handle => {
                                ...
                                handle.addEventListener('mousedown', (e) => this.startResize(e, role));
                            });
                        ...
                        startDrag(e) {
                            ...
                            this.dragHandler = (e) => this.onDrag(e);
                            this.dragEndHandler = (e) => this.stopDrag(e);
                        ...
                        startResize(e, type) {
                            ...
                            this.resizeEndHandler = (e) => this.stopResize(e);
